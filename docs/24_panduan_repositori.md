...
| Angka benchmark server FP32/PTQ/QAT | [Laporan benchmark server](23_server_openvino_benchmark.md) |
...
| `experiments/server_openvino/` | Raw benchmark diagnostik server | Bukan hasil deployment OP3 |
...
4. Baca [laporan server](23_server_openvino_benchmark.md) untuk angka latency, FPS, CPU, dan RSS yang aktual.
